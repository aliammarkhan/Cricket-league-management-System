...
Cricket_League:: ~Cricket_League(){  }    // definition of destructor 
...
int main()
{
	...
	Owners *O;
	Team *t;
	player *p=new player[100];       //dynamically allcoating class pointers
	...
	cout<<"Please enter number of Franchises"<<endl;
    }
	f=new Franchise[n];
	O=new Owners[n];
	t=new Team[n];
